...
//                        + "VALUES (" + dvp.getVentaPresupuestosLC().get(i).getPresupuestoLC().getPresupuesto().getExamenVista().getIdExamenVista() + ","
...
//                        + "VALUES (" + dvp.getVentaPresupuestosLC().get(i).getPresupuestoLC().getPresupuesto().getIdPresupuesto() + ","
//                        + dvp.getVentaPresupuestosLC().get(i).getPresupuesto().getAlturaOblea() + ","
